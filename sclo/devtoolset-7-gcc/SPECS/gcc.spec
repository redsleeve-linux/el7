...
Name: %{?scl_prefix}gcc
Version: %{gcc_version}
Release: %{gcc_release}.16%{?dist}.0.1
...
Patch10002: gcc7-arm-pr81942.patch
...
%changelog
* Tue Sep 10 2019 Pablo Greco <pgreco@centosproject.org> 7.3.1-5.16
- Fix for armhfp

* Tue Jul  9 2019 Marek Polacek <polacek@redhat.com> 7.3.1-5.16
