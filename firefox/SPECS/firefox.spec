...
%if %{build_langpacks}
Source1:        firefox-langpacks-%{version}%{?ext_version}-20171129.tar.xz
%endif
...
%changelog
* Wed Dec 06 2017 Jacco Ligthart <jacco@redsleeve.org> - 52.5.1-1.el7.redsleeve+- redsleeve default prefs
- limited the number of CPU's for building to 2 (OOM otherwise)

* Tue Dec  5 2017 Johnny Hughes <johnny@centos.org> - 52.5.1-1
