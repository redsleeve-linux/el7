...
%if %{build_langpacks}
Source1:        firefox-langpacks-%{version}%{?ext_version}-20180118.tar.xz
%endif
...
%changelog
* Sun Jan 28 2018 Jacco Ligthart <jacco@redsleeve.org> - 52.6.1-1.el7.redsleeve
- redsleeve default prefs
- limited the number of CPU's for building to 2 (OOM otherwise)

* Wed Jan 24 2018 Johnny Hughes <johnny@centos.org> - - 52.6.1-1
Manual CentOS Debranding

* Thu Jan 18 2018 Martin Stransky <stransky@redhat.com> - 52.6.1-1
