...
| elfutils | elfutils-0.172-2.el7.src.rpm | needs to be build with '-D "check exit 0" -D "debug_package %{nil}"'
...
| pykickstart | pykickstart-1.99.66.19-2.el7.src.rpm | needs to be build with '-D "check exit 0"'
...
| valgrind | valgrind-3.13.0-13.el7.src.rpm | version to new for armv5, keeping at version 3.10.0
| webkitgtk4 | webkitgtk4-2.20.5-1.el7.redsleeve.src.rpm | needs libatomic.so.1.2.0 from gcc7 to build
...
| Package | SRPM | reason
|---|---|---
| anaconda | anaconda-21.48.22.147-1.el7.centos.src.rpm | branding issue / removed because it was not used
...
| centos-release | centos-release-7-6.1810.2.el7.centos.src.rpm | replaced with redsleeve-release
| initial-setup | initial-setup-0.3.9.43-1.el7.centos.src.rpm | branding issue / removed because it was not used
| kabi-yum-plugins | kabi-yum-plugins-1.0-3.el7.centos.src.rpm | branding issue / removed because it was not used
| oscap-anaconda-addon | oscap-anaconda-addon-0.9-2.el7.centos.src.rpm | branding issue / removed because it was not used
| redhat-support-lib-python | redhat-support-lib-python-0.9.7-6.el7.src.rpm | branding issue / removed because it was not used
| redhat-support-tool | redhat-support-tool-0.9.10-1.el7.src.rpm | branding issue / removed because it was not used
| subscription-manager | subscription-manager-1.21.10-3.el7.centos.src.rpm | branding issue / removed because it was not used
...
| biosdevname | biosdevname-0.7.3-1.el7.src.rpm
...
| dmidecode | dmidecode-3.1-2.el7.src.rpm
| dyninst | dyninst-9.3.1-2.el7.src.rpm
| efibootmgr | efibootmgr-17-2.el7.src.rpm
| efivar | efivar-36-11.el7.src.rpm
| fence-virt | fence-virt-0.3.2-13.el7.src.rpm
...
| grub2 | grub2-2.02-0.76.el7.centos.src.rpm
...
| libguestfs | libguestfs-1.38.2-12.el7_6.1.src.rpm
...
| libvma | libvma-8.6.10-1.el7.src.rpm
| mcelog | mcelog-144-9.94d853b2ea81.el7.src.rpm
| memkind | memkind-1.7.0-1.el7.src.rpm
| memtest86+ | memtest86+-5.01-2.el7.src.rpm
| microcode_ctl | microcode_ctl-2.1-47.el7.src.rpm
...
| open-vm-tools | open-vm-tools-10.2.5-3.el7.src.rpm
| oracleasm | oracleasm-2.0.8-22.el7.src.rpm
| ovmf | ovmf-20180508-3.gitee3198e672e2.el7.src.rpm
| pesign | pesign-0.109-10.el7.src.rpm
| rasdaemon | rasdaemon-0.4.1-33.1.el7_5.src.rpm
| ras-utils | ras-utils-7.0-6.el7.src.rpm
| sanlock | sanlock-3.6.0-1.el7.src.rpm
| sbd | sbd-1.3.1-8.2.el7.src.rpm
| seabios | seabios-1.11.0-2.el7.src.rpm
| sgabios | sgabios-0.20110622svn-4.el7.src.rpm
| shim | shim-15-1.el7.centos.src.rpm
| shim-signed | shim-signed-15-1.el7.centos.src.rpm
| spice | spice-0.14.0-6.el7.src.rpm
...
| tpm2-abrmd | tpm2-abrmd-1.1.0-10.el7.src.rpm
| tpm2-tools | tpm2-tools-3.0.4-2.el7.src.rpm
| tpm2-tss | tpm2-tss-1.4.0-2.el7.src.rpm
...
| xorg-x11-drv-vesa | xorg-x11-drv-vesa-2.4.0-1.el7.src.rpm
...
| cockpit | cockpit-173-7.el7.centos.src.rpm | cannot be installed due to missing deps
...
| tuned | tuned-2.10.0-6.el7.src.rpm | cannot be installed due to missing deps
